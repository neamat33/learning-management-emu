        ...
        <div class="container-fluid px-3 px-xl-5">
            ...
            <div class="navbar-collapse w-100 collapse" id="navbarCollapse" style="margin-left: 100px">
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    ...
                    <li class="nav-item" style="margin-left: 2px">
                        <a href="<?php echo e(route('notice.index')); ?>" class="btn btn-primary-soft" style="font-weight: bold;padding: 8px 20px">নোটিশ</a>
                    </li>
                </ul>
                <!-- Nav Main menu END -->
                <!-- Nav Search START -->
                ...
                <div class="dropdown ms-1 ms-lg-0">
                    <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
                        <?php if(auth()->user()->image): ?>
                            <img class="avatar-img rounded-circle shadow" src="<?php echo e(asset(auth()->user()->image)); ?>" alt="avatar">
                        <?php else: ?>
                    ...
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                        ...
                        <li><a class="dropdown-item bg-danger-soft-hover" href="<?php echo e(route('student.logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="bi bi-power fa-fw me-2"></i>Sign Out</a></li>
            ...
            <?php else: ?>
                <div class="dropdown ms-1 ms-lg-0">
                    <a class="avatar avatar-sm p-0" href="<?php echo e(route('login')); ?>">
