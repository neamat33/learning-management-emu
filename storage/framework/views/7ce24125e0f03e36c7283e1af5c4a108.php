        ...
        <div class="container-fluid px-3 px-xl-5">
            ...
            <div class="navbar-collapse w-100 collapse" id="navbarCollapse" style="margin-left: 100px">
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    ...
                    <li class="nav-item" style="margin-left: 2px">
                        <a href="<?php echo e(route('course.page')); ?>" class="btn btn-primary-soft" style="font-weight: bold;padding: 8px 20px">কোর্সসমূহ</a>
                    </li>
                    <li class="nav-item" style="margin-left: 2px">
            ...
            <div class="dropdown ms-1 ms-lg-0">
                ...
                <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                    ...
                    <!-- Links -->
                    <li><a class="dropdown-item" href="<?php echo e(route('student.dashboard.page')); ?>"><i class="bi bi-grid-fill fa-fw me-1"></i>Dashboard</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('student_profile.update')); ?>"><i class="bi bi-person fa-fw me-2"></i>Edit Profile</a></li>
