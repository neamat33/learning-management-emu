            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-7 col-xl-6 text-center position-relative">
                    ...
                    <div class="position-relative">
                        <img style="height: 400px;width: 500px;border-radius: 2px;" src="<?php echo e(asset('web')); ?>/assets/images/book/book.jpg" alt="">
                    </div>
                </div>
                <!-- Right content END -->
            </div>
    ...
    <section>
        <div class="container">
            ...
            <ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab" role="tablist">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="nav-item me-2 me-sm-5">
                        <button class="nav-link mb-2 mb-md-0 <?php echo e($key == 0 ? 'active' : ''); ?>" id="course-pills-tab-<?php echo e($key+1); ?>" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-<?php echo e($key+1); ?>" type="button" role="tab" aria-controls="course-pills-tabs-<?php echo e($key+1); ?>" aria-selected="false"><?php echo e($category->name ?? '-'); ?></button>
                    </li>
            ...
            <div class="tab-content" id="course-pills-tabContent">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade show <?php echo e($key == 0 ? 'active' : ''); ?>" id="course-pills-tabs-<?php echo e($key+1); ?>" role="tabpanel" aria-labelledby="course-pills-tab-<?php echo e($key+1); ?>">
                        <div class="row g-4">
                            <!-- Card item START -->
                            <?php if($category->course->count() > 0): ?>
                                <?php $__currentLoopData = $category->course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-sm-6 col-lg-4 col-xl-3">
                                        <div class="card shadow h-100">
                                            <!-- Image -->
                                            <img src="<?php echo e(asset($item->image)); ?>" class="card-img-top" alt="course image" style="width: 298px; height: 175px">
                                            <!-- Card body -->
                                            <div class="card-body pb-0">
                                                ...
                                                <!-- Title -->
                                                <h5 class="card-title fw-normal"><a href="<?php echo e(route('course.details.page',encrypt($item->id))); ?>"><?php echo e($item->course_title); ?></a></h5>
                                                <!-- Rating star -->
                                            ...
                                            <div class="card-footer pt-0 pb-3">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <span class="h6 fw-light mb-0"><i class="far fa-clock text-danger me-2"></i><?php echo e(\Carbon\Carbon::parse($item->start_date)->format('d M Y')); ?></span>
                                                    <a href="<?php echo e(route('course.details.page',encrypt($item->id))); ?>">
                            ...
                            <?php else: ?>
                                <div style="text-align: center">
                                    <img style="height: 400px;width: 500px;border-radius: 2px;" src="<?php echo e(asset('web')); ?>/no-data.jpg" alt="">
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <div class="card action-trigger-hover border bg-transparent">
                                    <!-- Image -->
                                    <img src="<?php echo e(asset($course->image)); ?>" class="card-img-top" alt="course image" style="height: 300px;width: 400px">
                                    <!-- Card body -->
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <!-- Title -->
                                        <h5 class="card-title"><a href="<?php echo e(route('course.details.page',encrypt($course->id))); ?>"><?php echo e($course->course_title); ?></a></h5>
                                        <!-- Rating -->
                                        <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <div class="hstack gap-3">
                                            <span class="h6 fw-light mb-0"><i class="bi fa-fw bi-calendar-fill text-primary me-2"></i>ক্লাস শুরু: <?php echo e(\Carbon\Carbon::parse($course->start_date)->format('d M Y')); ?></span>
                                            <span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i><?php echo e($course->items->count()); ?> Subjects</span>
                                        </div>
                                    </div>
                                    <!-- Card footer -->
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <p class="mb-0 ms-2"><a href="<?php echo e(route('course.details.page',encrypt($course->id))); ?>" class="h6 fw-light mb-0">View Details</a></p>
                                            </div>
                                            <!-- Price -->
                                            <div>
                                                <h4 class="text-success mb-0 item-show">৳ <?php echo e($course->price); ?></h4>
                                                <a href="<?php echo e(route('cart.index',['course_id' => $course->id])); ?>" class="btn btn-sm btn-success-soft item-show-hover"><i class="fas fa-shopping-cart me-2"></i>Buy Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-7 order-2 order-xl-1">
                        ...
                        <div class="col-md-7 position-relative mb-0 mt-0 mt-md-5">
                            ...
                            <div class="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                                ...
                                <div class="avatar avatar-xl mb-3">
                                    <img class="avatar-img rounded-circle" src="<?php echo e(asset('web')); ?>/assets/images/avatar/01.jpg" alt="avatar">
                                </div>
                                <!-- Content -->
                                <blockquote>
                                    <p>
                            ...
                            <div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1" src="<?php echo e(asset('web')); ?>/assets/images/avatar/09.jpg" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1" src="<?php echo e(asset('web')); ?>/assets/images/avatar/04.jpg" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                                ...
                                <div class="d-flex align-items-center">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1" src="<?php echo e(asset('web')); ?>/assets/images/avatar/02.jpg" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                    ...
                    <div class="row mt-5 mt-xl-0">
                        ...
                        <div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                            ...
                            <div class="p-3 bg-primary d-inline-block rounded-4 shadow-lg text-center" style="background:url(<?php echo e(asset('web')); ?>/assets/images/pattern/02.png) no-repeat center center; background-size:cover;">
                                <!-- Info -->
                        ...
                        <div class="col-md-5 mt-n6 mb-0 mb-md-5">
                            <div class="bg-body shadow text-center p-4 rounded-3">
                                <!-- Avatar -->
                                <div class="avatar avatar-xl mb-3">
                                    <img class="avatar-img rounded-circle" src="<?php echo e(asset('web')); ?>/assets/images/avatar/03.jpg" alt="avatar">
                                </div>
                                <!-- Content -->
                                <blockquote>
                                    <p>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\learning-management-emu\resources\views/frontend/index.blade.php ENDPATH**/ ?>