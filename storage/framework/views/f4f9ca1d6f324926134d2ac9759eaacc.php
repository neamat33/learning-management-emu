                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <input name="subject_id[]" type="checkbox" value="<?php echo e($subject->id); ?>"
                                        <?php if(in_array($subject->id, explode(',', $single->subject_id))): ?> checked <?php endif; ?>> &nbsp;
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\learning-management-emu\resources\views/admin/subject_assign/edit.blade.php ENDPATH**/ ?>