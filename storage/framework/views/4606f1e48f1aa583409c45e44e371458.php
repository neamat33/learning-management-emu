        ...
        <div class="container" data-sticky-container>
            <div class="row g-4 g-sm-5">
                ...
                <div class="col-xl-8">
                    ...
                    <!-- Title -->
                    <h1 class="mb-4"><?php echo e($course->course_title); ?></h1>
                    <div>
                        <div class="list-group-item px-0 mb-4">
                            ...
                            <span class="h6"><?php echo e(\Carbon\Carbon::parse($course->start_date)->format('d M Y')); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="tab-content pt-4 px-3 mb-4">
                            ...
                            <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="book-pills-tab-1">
                                <div class="row g-2">
                                    <?php $__currentLoopData = $getInstructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-sm-6 col-xl-4">
                                            <div class="d-flex justify-content-lg-center align-items-center p-3 bg-blue bg-opacity-10 rounded-3 shamim-border shamim-style">
                                                ...
                                                <div class="ms-4 h6 fw-normal mb-0">
                                                    <div class="">
                                                        <p class="mb-1"><?php echo e($data->instructor->name ?? '-'); ?></p>
                                                        <p class="mb-0" style="font-size: 12px"><?php echo e($data->instructor->subject->subject_name ?? '-'); ?></p>
                                                        <p class="mb-0" style="font-size: 12px"><?php echo e($data->instructor->qualification ?? '-'); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="tab-content" id="course-pills-tabContent">
                                                ...
                                                <div class="tab-pane fade show active" id="course-pills-1" role="tabpanel" aria-labelledby="course-pills-tab-1">
                                                    ...
                                                    <div class="accordion accordion-icon accordion-border" id="accordionExample2">
                                                      <?php $__currentLoopData = $getInstructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="accordion-item mb-3">
                                                            <h6 class="accordion-header font-base" id="heading-<?php echo e($key+1); ?>">
                                                                <button class="accordion-button fw-bold collapsed rounded d-flex" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo e($key+1); ?>" aria-expanded="false" aria-controls="collapse-<?php echo e($key+1); ?>">
                                                                    <i class="fas fa-fw fa-file fs-7" style="color: darkgray"></i> <?php echo e($data->subject->subject_name ?? '-'); ?>

                                                                </button>
                                                            </h6>
                                                            <div id="collapse-<?php echo e($key+1); ?>" class="accordion-collapse collapse" aria-labelledby="heading-<?php echo e($key+1); ?>" data-bs-parent="#accordionExample2">
                                                                <!-- Accordion body START -->
                                                                <div class="accordion-body mt-3">
                                                                    <!-- Course assignment -->
                                                                    <?php $__currentLoopData = $data->chapter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <div class="d-flex justify-content-between align-items-center">
                                                                        <div class="position-relative d-flex align-items-center">
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <!-- Content -->
                                                                                <div class="ms-3">
                                                                                    <a href="#" class="d-inline-block text-truncate mb-0 h6 fw-normal w-100px w-sm-200px w-md-400px"><?php echo e($value->chapter_name ?? '-'); ?></a>
                                                                                </div>
                    ...
                    <div class="col-12">
                        ...
                        <ul class="nav nav-pills nav-pills-bg-soft px-3" id="book-pills-tab" role="tablist">
                            ...
                            <!-- Tab item -->
                            <li class="nav-item me-2 me-sm-4" role="presentation">
                                <a href="<?php echo e(route('download.image',encrypt($course->id))); ?>" class="btn btn-success-soft mb-2 mb-sm-0 me-00 me-sm-3"><i class="fa fa-download me-2"></i>ডাউনলোড করো</a>
                            </li>
                            <!-- Tab item -->
                        </ul>
                        <!-- Tabs END -->
                                ...
                                <div class="row g-4">
                                    <div class="col-md-12">
                                        <div style="height: 340px">
                                            <img  src="<?php echo e(asset($course->class_routine)); ?>" style="height: 340px;width: 100%" class="rounded-3" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\learning-management-emu\resources\views/frontend/course_details.blade.php ENDPATH**/ ?>