                                                                    ...
                                                                    <div class="d-flex justify-content-between align-items-center">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <a data-glightbox data-gallery="office-tour" href="https://www.youtube.com/embed/tXHviS-4ygo" class="icon-md position-relative">
                                                                                <img src="<?php echo e(asset('web')); ?>/assets/images/courses/4by3/01.jpg" class="rounded-1"  alt="">
                                                        ...
                                                        <div class="card-body p-0 pt-3">
                                                            ...
                                                            <div class="row g-4">
                                                                ...
                                                                <div class="col-sm-2 col-xl-1">
                                                                    <img src="<?php echo e(asset('web')); ?>/assets/images/courses/4by3/01.jpg" class="rounded flex-shrink-0" alt="">
                                                                </div>
                                                                <!-- Content -->
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="d-sm-flex justify-content-sm-between mb-3">
                                                                        <div class="d-flex align-items-center">
                                                                            <!-- Avatar -->
                                                                            <div class="avatar avatar-sm flex-shrink-0">
                                                                                <img class="avatar-img rounded-circle" src="<?php echo e(asset('web')); ?>/assets/images/avatar/05.jpg" alt="avatar">
                                                                            </div>
                                                                            <!-- Info -->
                                                                            <div class="ms-2">
