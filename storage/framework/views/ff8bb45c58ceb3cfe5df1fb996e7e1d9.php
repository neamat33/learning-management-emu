    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header py-3 d-flex align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Student Registration Update</h6>
                    ...
                    <div class="modal-body ">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input name="student_name" id="student_name" value="<?php echo e(old('student_name')); ?>"
                            ...
                            <div class="form-group col-md-4 mt-1">
                                ...
                                <input name="father_name" id="mobile" value="<?php echo e(old('father_name')); ?>"
                                    class="form-control mt-1" />
                            ...
                            <div class="form-group col-md-4 mt-1">
                                ...
                                <input name="mother_name" id="mother_name" value="<?php echo e(old('mother_name')); ?>"
                                    class="form-control mt-1" />
                                <?php if($errors->has('father_name')): ?>
                            ...
                            <div class="form-group col-md-4 mt-1">
                                ...
                                <input type="number" name="father_mobile" id="father_mobile" value="<?php echo e(old('father_mobile')); ?>"
                                    class="form-control mt-1" />
                            ...
                            <div class="form-group col-md-4 mt-1">
                                ...
                                <input type="number" name="mother_mobile" id="mother_mobile" value="<?php echo e(old('mother_mobile')); ?>"
                                    class="form-control mt-1" />
                                <?php if($errors->has('father_name')): ?>
                            ...
                            <div class="form-group col-md-4 mt-1">
                                ...
                                <input type="email" name="father_email" id="father_email" value="<?php echo e(old('father_email')); ?>"
                                    class="form-control mt-1" />
                            ...
                            <div class="form-group col-md-4 mt-1">
                                ...
                                <input type="email" name="mother_email" id="mother_email" value="<?php echo e(old('mother_email')); ?>"
                                    class="form-control mt-1" />
                            ...
                            <div class="form-group col-md-4 mt-1">
                                ...
                                <textarea name="note" class="form-control mt-1" rows="1"><?php echo e(old('note')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\learning-management-emu\resources\views/admin/student/create.blade.php ENDPATH**/ ?>