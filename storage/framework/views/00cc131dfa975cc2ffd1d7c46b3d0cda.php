                            ...
                            <div class="form-group col-md-4">
                                ...
                                <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <input name="section_id[]" type="checkbox" value="<?php echo e($section->id); ?>"
                                        <?php if(in_array($section->id, explode(',', $single->section_id))): ?> checked <?php endif; ?>> &nbsp;
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\learning-management-emu\resources\views/admin/class_setup/edit.blade.php ENDPATH**/ ?>