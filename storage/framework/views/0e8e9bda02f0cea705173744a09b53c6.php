                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($item->status_id == 1): ?>
                                    <a href="<?php echo e(route('class.inactive',$item->id)); ?>" class="badge bg-success set-status"  title="change to InActive">Active</a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('class.active',$item->id)); ?>" class="badge bg-danger" title="change to active">Inactive</a>
                                <?php endif; ?>
                            </td>
                            <td>
                                ...
                                <a href="<?php echo e(route('class.delete',$item->id)); ?>" class="btn btn-danger btn-circle btn-sm editBtn">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\learning-management-emu\resources\views/admin/class/list.blade.php ENDPATH**/ ?>