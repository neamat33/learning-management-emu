...
class UserController extends Controller
{
    ...
    {
        $departments=Branch::where('status_id',1)->orderBy('id','desc')->get();
    ...
    {
        $branch=Branch::where('status_id',1)->orderBy('id','desc')->get();
        $roles = Role::where('name','!=','test_admin')->get();
        return view('admin.user.create',compact('branch','roles'));
    }
