                    ...
                    <div class="modal-body ">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input name="student_name" id="student_name" value="{{ old('student_name') }}"
                            ...
                            <div class="form-group col-md-4 mt-1">
                                ...
                                <input name="father_name" id="mobile" value="{{ old('father_name') }}"
                                    class="form-control mt-1" />
                            ...
                            <div class="form-group col-md-4 mt-1">
                                ...
                                <input name="mother_name" id="mother_name" value="{{ old('mother_name') }}"
                                    class="form-control mt-1" />
                                @if ($errors->has('father_name'))
                            ...
                            <div class="form-group col-md-4 mt-1">
                                ...
                                <input type="number" name="father_mobile" id="father_mobile" value="{{ old('father_mobile') }}"
                                    class="form-control mt-1" />
                            ...
                            <div class="form-group col-md-4 mt-1">
                                ...
                                <input type="number" name="mother_mobile" id="mother_mobile" value="{{ old('mother_mobile') }}"
                                    class="form-control mt-1" />
                                @if ($errors->has('father_name'))
