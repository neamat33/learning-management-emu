...
@section('page-title', 'Notice Create')
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-2 mb-2"><span class="text-muted fw-light">Notice Create</span></h4>

        <!-- DataTable with Buttons -->
        <div class="card">
            <div class="card-header py-3 d-flex align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Notice Add</h6>
                    ...
                    <div class="modal-body ">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input name="subject" id="subject" value="{{ old('subject') }}" class="form-control mt-1" required>
                            ...
                            <div class="form-group col-md-12 mt-1">
                                ...
                                <textarea name="message" class="form-control mt-1" rows="5" required>{{ old('message') }}</textarea>
