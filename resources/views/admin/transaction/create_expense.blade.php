...
@section('page-title', 'Expense Transaction')
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header py-3 d-flex align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Expense Transaction</h6>
                    ...
                    <div class="modal-body ">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="tnx_cat_id" id="tnx_cat_id" class="form-select select2 mt-1" data-allow-clear="true">
                                    <option value="" disabled selected>--Select Category--</option>
                                    @foreach ($expense_category as $expense_cat)
                                        <option value="{{ $expense_cat->id }}">{{ $expense_cat->tnx_name }}</option>
                                    @endforeach

                                </select>
                                <input type="hidden" name="tnx_type_id" value="2">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            {{-- <div class="form-group col-md-6">
                                ...
                                <select name="tnx_user_type" id="tnx_user_type" class="form-select mt-1">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="tnx_user_id" id="" class="select2 form-select mt-1" data-allow-clear="true">
                                    <option value="" disabled selected>--Select--</option>
                                    @foreach ($students as $student)
                                        <option value="{{ $student->id }}">
                                            {{ $student->student_name . '-' . $student->mobile }}</option>
                                    @endforeach
                                </select>
                            </div> --}}
                            ...
                            <div class="form-group col-md-6 mt-2">
                                ...
                                <select name="tnx_ac_id" id="tnx_ac_id" class="form-select mt-1">
                                    ...
                                    @foreach ($accounts as $account)
                                        <option value="{{ $account->id }}" data-curr_blance='{{ $account->curr_blance }}'>
    ...
    <script>
        ...
        $(document).on('change', '#tnx_ac_id', function() {
            ...
            $(document).on('keyup', '#amount', function() {
                let curr_blance = parseFloat($('#current_balance').text());
                let amount = parseFloat($("#amount").val());
                if (amount > curr_blance) {
