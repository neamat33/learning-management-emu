                ...
                <table class="datatable table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item->status_id == 1)
                                    <a href="{{route('section.inactive',$item->id)}}" class="badge bg-success set-status"  title="change to InActive">Active</a>
                                @else
                                    <a href="{{route('section.active',$item->id)}}" class="badge bg-danger" title="change to active">Inactive</a>
                                @endif
                            </td>
                            <td>
                                ...
                                <a href="{{route('section.delete',$item->id)}}" class="btn btn-danger btn-circle btn-sm editBtn">
