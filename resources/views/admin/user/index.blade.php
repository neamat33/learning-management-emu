                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary mb-2"
                                                            ...
                                                            data-bs-target=".bd-example-modal-lg{{ $item->id }}"><i
                                                                class="fas fa-edit"></i></button>
                                                        <button type="button" class="btn btn-danger mb-2" href=""
                                                            data-bs-toggle="modal" data-bs-target=".delete-modal"
                                                            onclick="handle({{ $item->id }})"><i
                                                                class="fas fa-trash"></i></button>
                                                        <div class="modal fade bd-example-modal-lg{{ $item->id }}"
                                                            tabindex="-1" role="dialog" aria-hidden="true">
                                                            <div class="modal-dialog modal-lg">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title">Edit {{ $item->name }}
                                                                        </h5>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="mb-3 col-md-6">
                                                                                    ...
                                                                                    @if ($errors->has('department_id'))
                                                                                        <span
                                                                                            class="invalid-feedback">{{ $errors->first('department_id') }}</span>
                                                                                    @endif
                                                                                </div>
                                                                                <div class="mb-3 col-md-6">
                                                                                    ...
                                                                                    @if ($errors->has('role'))
                                                                                        <span
                                                                                            class="invalid-feedback">{{ $errors->first('role') }}</span>
                                                                                    @endif
                                                                                </div>
                                                                            </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="sumit" class="btn btn-primary">Save
                                                                            changes</button>
                                                                    </div>
                                                                    </form>
                                                                </div>
