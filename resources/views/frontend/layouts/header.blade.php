<header class="navbar-light navbar-sticky header-static">
    ...
    <nav class="navbar navbar-expand-xl">
        <div class="container-fluid px-3 px-xl-5">
            ...
            @if(auth()->check())
                <div class="dropdown ms-1 ms-lg-0">
                    <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
                        @if(auth()->user()->image)
                            <img class="avatar-img rounded-circle shadow" src="{{asset(auth()->user()->image)}}" alt="avatar">
                        @else
                    ...
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                        ...
                        <li><a class="dropdown-item bg-danger-soft-hover" href="{{route('student.logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="bi bi-power fa-fw me-2"></i>Sign Out</a></li>
            ...
            @else
                <div class="dropdown ms-1 ms-lg-0">
                    <a class="avatar avatar-sm p-0" href="{{route('login')}}">
