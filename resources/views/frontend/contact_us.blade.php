...
@section('content')
    <!-- =======================
Page Banner START -->
    <section class="pt-5 pb-0" style="background-image:url({{'web'}}/assets/images/element/map.svg); background-position: center left; background-size: cover;">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row g-4 g-lg-0 align-items-center">
                ...
                <div class="col-md-6 align-items-center text-center">
                    <!-- Image -->
                    <img src="{{'web'}}/assets/images/element/contact.svg" class="h-400px" alt="">
