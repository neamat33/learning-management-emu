                        ...
                        <div class="offcanvas-body p-3 p-xl-0">
                            <div class="bg-dark border rounded-3 pb-0 p-3 w-100">
                                ...
                                <div class="list-group list-group-dark list-group-borderless">
                                    ...
                                    <a class="list-group-item active" href="{{route('student_course.details')}}"><i class="far fa-fw fa-file-alt me-2"></i>Course Resume</a>
                    ...
                    <div class="card border mt-4">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card">
                                <div class="row g-0">
                                    <div class="col-md-3">
                                        <img src="{{asset('web')}}/assets/images/courses/4by3/08.jpg" class="rounded-2" alt="Card image">
                                    </div>
                                    <div class="col-md-9">
                                        <div class="card-body">
                                            <!-- Title -->
