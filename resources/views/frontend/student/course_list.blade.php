                        ...
                        <div class="offcanvas-body p-3 p-xl-0">
                            <div class="bg-dark border rounded-3 pb-0 p-3 w-100">
                                ...
                                <div class="list-group list-group-dark list-group-borderless">
                                    <a class="list-group-item" href="{{route('student.dashboard.page')}}"><i class="bi bi-ui-checks-grid fa-fw me-2"></i>Dashboard</a>
                                    <a class="list-group-item active" href="{{route('student_course.list')}}"><i class="bi bi-basket fa-fw me-2"></i>My Courses</a>
                                    <a class="list-group-item" href="{{route('student_course.details')}}"><i class="far fa-fw fa-file-alt me-2"></i>Course Resume</a>
                                    <a class="list-group-item" href="{{route('student_course.quiz')}}"><i class="bi bi-question-diamond fa-fw me-2"></i>Quiz</a>
                                    <a class="list-group-item" href="{{route('student_profile.update')}}"><i class="bi bi-pencil-square fa-fw me-2"></i>Edit Profile</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <!-- Image -->
                                                <div class="w-100px">
                                                    <img src="{{asset('web')}}/assets/images/courses/4by3/08.jpg" class="rounded" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <!-- Image -->
                                                <div class="w-100px">
                                                    <img src="{{asset('web')}}/assets/images/courses/4by3/03.jpg" class="rounded" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <!-- Image -->
                                                <div class="w-100px">
                                                    <img src="{{asset('web')}}/assets/images/courses/4by3/05.jpg" class="rounded" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <!-- Image -->
                                                <div class="w-100px">
                                                    <img src="{{asset('web')}}/assets/images/courses/4by3/01.jpg" class="rounded" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <!-- Image -->
                                                <div class="w-100px">
                                                    <img src="{{asset('web')}}/assets/images/courses/4by3/02.jpg" class="rounded" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
