        ...
        <div class="container">
            ...
            <div class="row g-4 mt-0 mt-lg-5">
                ...
                <div class="col-6 col-md-4">
                    <div class="row g-4">
                        ...
                        <div class="col-10 col-lg-6">
                            <img class="rounded-4" src="{{'web'}}/assets/images/about/05.jpg" alt="">
                        </div>
                        <!-- Image -->
                        <div class="col-12">
                            <img class="rounded-4" src="{{'web'}}/assets/images/about/03.jpg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4 position-relative">
                    ...
                    <!-- Image -->
                    <img class="rounded-4" src="{{'web'}}/assets/images/about/09.jpg" alt="">
                </div>
                ...
                <div class="col-md-4">
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6 col-md-12 col-lg-6">
                            <img class="rounded-4" src="{{'web'}}/assets/images/about/10.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 position-relative">
                    ...
                    <!-- Image -->
                    <img src="{{'web'}}/assets/images/about/06.jpg" class="rounded" alt="">
                </div>
